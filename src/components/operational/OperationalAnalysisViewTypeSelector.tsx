...
const analysisTypes = {
  contable: {
    ...
    objective: '¿Cuál es el desempeño operativo según principios contables?',
    color: 'primary',
    features: ['✓ Depreciación incluida', '✓ Intereses incluidos', '✓ Enfoque a largo plazo'],
    literature: {
      title: 'Análisis Operativo Contable',
      definition: 'Evaluación del desempeño operativo considerando todos los gastos contables incluyendo depreciación e intereses.',
      purpose: 'Proporcionar una visión completa del rendimiento operativo según estándares contables para reportes financieros.',
      includes: ['Todos los costos operativos', 'Depreciación y amortización', 'Gastos financieros (intereses)', 'Todos los gastos contables'],
      useCase: 'Ideal para reportes financieros, análisis de rentabilidad a largo plazo y evaluación del desempeño contable global de las operaciones.'
    }
  },
  operativo: {
    id: 'operativo',
    ...
    objective: '¿Qué tan eficientes son nuestras operaciones puras?',
    color: 'accent',
    features: ['✓ Depreciación incluida', '✗ Intereses excluidos', '✓ Eficiencia operativa'],
    literature: {
      title: 'Análisis Operativo EBIT',
      definition: 'Evaluación del desempeño operativo antes de intereses e impuestos, enfocándose en la eficiencia operativa pura.',
      ...
      useCase: 'Perfecto para evaluar la eficiencia operativa, comparar diferentes períodos y tomar decisiones operativas independientes del financiamiento.'
    }
  },
  caja: {
    id: 'caja',
    ...
    objective: '¿Cuánto efectivo generan nuestras operaciones?',
    color: 'warning',
    features: ['✗ Depreciación excluida', '✓ Intereses incluidos', '✓ Generación de caja'],
    literature: {
      title: 'Análisis Operativo de Caja (EBITDA)',
      definition: 'Evaluación del desempeño operativo basado en flujos de efectivo, excluyendo gastos no monetarios.',
      purpose: 'Determinar la capacidad real de generación de efectivo de las operaciones.',
      ...
      useCase: 'Crítico para gestión de liquidez, evaluación de flujo de caja operativo y análisis de capacidad de generación de efectivo.'
    }
  }
} as const;
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className={`text-xl font-display text-${selectedConfig.color} mb-2`}>
              Análisis Operativo {selectedConfig.name}
            </h3>
